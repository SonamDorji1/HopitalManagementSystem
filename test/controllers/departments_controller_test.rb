...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { name: @department.name, references: @department.references } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { name: @department.name, references: @department.references } }
